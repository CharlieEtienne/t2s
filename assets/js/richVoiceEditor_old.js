...
var RichVoiceEditor = function (_Module) {
    _inherits(RichVoiceEditor, _Module);

    function RichVoiceEditor(quill, options) {
        _classCallCheck(this, RichVoiceEditor);

        var _this = _possibleConstructorReturn(this, (RichVoiceEditor.__proto__ || Object.getPrototypeOf(RichVoiceEditor)).call(this, quill, options));
...
*/
        ...
        toolbar.addHandler('ssml_break', ssml_break_handler.bind(_this));
...
*/
        ...
        // add tag handler to quill toolbar
        toolbar.addHandler('ssml_emphasis', ssml_emphasis_handler.bind(_this));
        ...
        // add tag handler to quill toolbar
        toolbar.addHandler('ssml_rate', ssml_rate_handler.bind(_this));
        ...
        // add tag handler to quill toolbar
        toolbar.addHandler('ssml_pitch', ssml_pitch_handler.bind(_this));
        ...
        // add tag handler to quill toolbar
        // toolbar.addHandler('ssml_whispering', ssml_whispering_handler.bind(_this));

        // SSML lang tag
        // -------------
        // load texts for dropdown items
        var languagePickerItems = Array.prototype.slice.call(document.querySelectorAll('.ql-ssml_language .ql-picker-item'));
        languagePickerItems.forEach(function (item) {
            return item.textContent = item.dataset.value;
        });
        // style toolbar button with icon and keep dropdown values
        ...
        // add tag handler to quill toolbar
        toolbar.addHandler('ssml_language', ssml_language_handler.bind(_this));
        ...
        // add tag handler to quill toolbar
        // toolbar.addHandler('ssml_paragraph', ssml_paragraph_handler.bind(_this));

        // SSML say-as tag
        // ---------------
        // load texts for dropdown items
        var sayasPickerItems = Array.prototype.slice.call(document.querySelectorAll('.ql-ssml_sayas .ql-picker-item'));
        sayasPickerItems.forEach(function (item) {
            return item.textContent = item.dataset.value;
        });
        // style toolbar button with icon and keep dropdown values
...
*/
        ...
        // add tag handler to quill toolbar
        toolbar.addHandler('ssml_sayas', ssml_sayas_handler.bind(_this));
        ...
        // add tag handler to quill toolbar
        toolbar.addHandler('ssml_date', ssml_date_handler.bind(_this));
        ...
        // add tag handler to quill toolbar
        // toolbar.addHandler('ssml_substitute', ssml_substitute_handler.bind(_this));
        ...
        // toolbar.addHandler('ssml_parse', ssml_parse_handler.bind(_this));
        ...
        // add function handler to quill toolbar
        // toolbar.addHandler('ssml_validate', ssml_validate_handler.bind(_this));
...
/***/ })
/******/ ]);
//# sourceMappingURL=richVoiceEditor.js.map